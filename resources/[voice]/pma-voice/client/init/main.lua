...
if gameVersion == 'fivem' then
	...
	SetAudioSubmixEffectRadioFx(megaphoneEffectId, 3)
	SetAudioSubmixEffectParamInt(megaphoneEffectId, 3, `default`, 1)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `freq_low`, 10.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `freq_hi`, 10000.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `rm_mod_freq`, 300.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `rm_mix`, 0.2)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `fudge`, 0.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `o_freq_lo`, 200.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 3, `o_freq_hi`, 5000.0)
	AddAudioSubmixOutput(megaphoneEffectId, 3)
end
