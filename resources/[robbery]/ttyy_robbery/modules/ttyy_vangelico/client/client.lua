...
RegisterNetEvent('ttyy_vdoors:set')
AddEventHandler('ttyy_vdoors:set', function(doorId, isLocked)
    DoorSystemSetDoorState(doorId, isLocked and 1 or 0)
end)

RegisterNetEvent('ttyy_vdoors:initialize')
AddEventHandler('ttyy_vdoors:initialize', function(allDoors)
...
RegisterNetEvent('ttyy_vangelico:thermite')
AddEventHandler('ttyy_vangelico:thermite', function()
    ...
    if canthermite then
        ...
        exports['ttyy_robbery']:thermiteminigame(10, 3, 3, 10,
        function() -- success
            --print("success")
                ...
                TriggerServerEvent('ttyy_vangelico:particleserver', method)
                ...
                successful = true
                TriggerServerEvent('ttyy_vangelico:thermitedelete')
...
RegisterNetEvent('ttyy_vangelico:ptfxparticle')
AddEventHandler('ttyy_vangelico:ptfxparticle', function(method)
    local ptfx
...
function giveitems()
    TriggerServerEvent('ttyy_vangelico:rewards')
end
...
RegisterNetEvent('ttyy_vangelico:loot')
AddEventHandler('ttyy_vangelico:loot', function(name)
    ...
    while true do
        ...
        if jewelry then
            ...
            for i = 1, #players, 1 do
                TriggerServerEvent('ttyy_vangelico:allnotify', GetPlayerServerId(players))
            end
            Citizen.Wait(600000)
            ExecuteCommand('vdoors 1')
            ExecuteCommand('vdoors 2')
        ...
        exports['qtarget']:AddBoxZone('Case_Zone'..k, v.location, v.size[1], v.size[2],
            {
                ...
                options = {{
                    ...
                    action = function()
                        local name = k
                        TriggerEvent('ttyy_vangelico:loot', name)
                    end
...
AddEventHandler('ttyy_vangelico:alarmBlip', function()
	local transT = 250
	local Blip = AddBlipForCoord(Config_Vangelico.BlipCoords)
