...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://ttyy_robbery/close', JSON.stringify({}));
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_robbery/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'SELECTED') {
            ...
            $(this).text('SELECTED');
            $.post('https://ttyy_robbery/addjob', JSON.stringify({
