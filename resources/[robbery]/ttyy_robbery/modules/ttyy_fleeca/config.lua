Config_Fleeca = {}
Config_Fleeca.hacktime = 2000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
Config_Fleeca.maxcash = 10000 -- maximum amount of cash a pile can hold
Config_Fleeca.mincash = 5000 -- minimum amount of cash a pile holds
...
Config_Fleeca.mincops = 0 -- minimum required cops to start mission
