...
function UTK:GetInfo()
    ESX.TriggerServerCallback("marskuy_ganteng:GetData", function(output)
        self.info = output
        self:HandleInfo()
    end)
end
            ...
            CreateThread(function()
                while true do
                    ...
                    local coords = GetEntityCoords(PlayerPedId())
                        ...
                        if dst <= 6 then
                            sleep = 5
                            DrawText3DBank(self.loudstart.x, self.loudstart.y, self.loudstart.z, self.text.loudstart, 0.40)
                            if dst <= 1 and IsControlJustReleased(0,38) then

                                ESX.TriggerServerCallback("marskuy_ganteng:startevent", function(output)
                                    if output == true then
                                        UTK.initiator = true
                                        self.info.stage = 1
                                        self.info.style = 1
                                    ...
                                    elseif output ~= true then
                                        ESX.ShowNotification(output, 'error')
                                    end
                                end, 1)
                            end
                        end
                        ...
                        if dst2 <= 6 then
                            sleep = 5
                            DrawText3DBank(self.silentstart.x, self.silentstart.y, self.silentstart.z, self.text.silentstart, 0.40)
                    ...
                    CreateThread(function()
                        while true do
                            ...
                            if not UTK.checks.hack1 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.hack1.x, self.hack1.y, self.hack1.z, self.text.usehack, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                            if output then
                                                UTK.checks.hack1 = true
                                                self.currenthack = 0
                                                self:Hack()
                                            elseif not output then
                                                ESX.ShowNotification("You don't have a hacker laptop.", 'error')
                            ...
                            if UTK.checks.hack1 and not UTK.checks.hack2 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.hack2.x, self.hack2.y, self.hack2.z, self.text.usehack, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                            if output then
                    ...
                    CreateThread(function()
                        while true do
                            ...
                            if not UTK.checks.id1 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.card1.x, self.card1.y, self.card1.z, self.text.usecard, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                        if output then
                                            UTK.checks.id1 = true
                                            ...
                                            self:IdCard()
                                        elseif not output then
                                            ESX.ShowNotification("You don't have ID Card.", 'error')
                                        end
                                        end, "id_card")
                                    end
                                end
                                ...
                                for i = 1, #UTK.searchlocations, 1 do
                                    if not UTK.searchlocations[i].status then
                                        if GetDistanceBetweenCoords(coords, UTK.searchlocations[i].coords.x, UTK.searchlocations[i].coords.y, UTK.searchlocations[i].coords.z, true) <= 2.2 then
                                            DrawText3DBank(UTK.searchlocations[i].coords.x, UTK.searchlocations[i].coords.y, UTK.searchlocations[i].coords.z, self.text.usesearch, 0.40)
                            ...
                            if UTK.checks.id1 and not UTK.checks.id2 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.card2.x, self.card2.y, self.card2.z, self.text.usecard, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                        if output then
                                            TriggerServerEvent("marskuy_ganteng:removeitem", "id_card")
                                            UTK.checks.id2 = true
                                            self.currentid = 2
                                            self:IdCard()
                                        elseif not output then
                    ...
                    CreateThread(function()
                        while true do
                            ...
                            if not UTK.checks.thermal1 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.thermal1.x, self.thermal1.y, self.thermal1.z, self.text.usethermal, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                            if output then
                                                TriggerServerEvent("marskuy_ganteng:removeitem", "thermite")
                                                UTK.checks.thermal1 = true
                                                self.currentplant = 1
                                                self:Plant()
                                            elseif not output then
                                                ESX.ShowNotification("You don't have any thermal charges.", 'error')
                            ...
                            if UTK.checks.thermal1 and not UTK.checks.thermal2 then
                                ...
                                if dst <= 4 then
                                    sleep = 5
                                    DrawText3DBank(self.thermal2.x, self.thermal2.y, self.thermal2.z, self.text.usethermal, 0.40)
                                    if dst <= 1 and IsControlJustReleased(0, 38) then
                                        ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                            if output then
                                                TriggerServerEvent("marskuy_ganteng:removeitem", "thermite")
                        ...
                        CreateThread(function()
                            while true do
                                ...
                                if not UTK.checks.lockpick1 then
                                    ...
                                    if dst <= 4 then
                                        sleep = 5
                                        DrawText3DBank(self.lockpick1.x, self.lockpick1.y, self.lockpick1.z, self.text.uselockpick, 0.40)
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                                if output then
                                                    TriggerServerEvent("marskuy_ganteng:removeitem", "lockpick")
                                                    UTK.checks.lockpick1 = true
                                                    self.currentpick = 1
                                                    self:Lockpick()
                                                elseif not output then
                                                    ESX.ShowNotification("You don't have any lockpick.", 'error')
                                                end
                                            end, "lockpick")
                                        end
                                    end
                                ...
                                if not UTK.checks.lockpick2 then
                                    ...
                                    if dst <= 4 then
                                        sleep = 5
                                        DrawText3DBank(self.lockpick2.x, self.lockpick2.y, self.lockpick2.z, self.text.uselockpick, 0.40)
                                        if dst <= 1 and IsControlJustReleased(0, 38) then
                                            ESX.TriggerServerCallback("marskuy_ganteng:checkItem", function(output)
                                                if output then
                                                    TriggerServerEvent("marskuy_ganteng:removeitem", "lockpick")
...
function UTK:Plant()
    ...
    TriggerServerEvent("marskuy_ganteng:ptfx", method)
    ...
    if self.currentplant == 0 then
        TriggerServerEvent("marskuy_ganteng:fixdoor", self.doorchecks[1].h, vector3(self.doorchecks[1].x, self.doorchecks[1].y, self.doorchecks[1].z), self.doorchecks[1].he)
    elseif self.currentplant == 1 then
        TriggerServerEvent("marskuy_ganteng:fixdoor", self.doorchecks[4].h, vector3(self.doorchecks[4].x, self.doorchecks[4].y, self.doorchecks[4].z), self.doorchecks[4].he)
    elseif self.currentplant == 2 then
        TriggerServerEvent("marskuy_ganteng:fixdoor", self.doorchecks[5].h, vector3(self.doorchecks[5].x, self.doorchecks[5].y, self.doorchecks[5].z), self.doorchecks[5].he)
    end
    ...
    Wait(2000)
    if self.currentplant == 0 then
        TriggerServerEvent("marskuy_ganteng:alarm_s", 1)
    end
    DeleteObject(bomba)
    TriggerServerEvent("marskuy_ganteng:moltgate", loc.x, loc.y, loc.z, oldmodel, newmodel)
    Wait(9000)
    ESX.ShowNotification(self.text.melted)
    StopParticleFxLooped(effect, 0)
    if self.currentplant == 0 then
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", newmodel, vector3(self.loudstart.x, self.loudstart.y, self.loudstart.z), false)
        local data = {displayCode = '10-90', description = 'Bank Robbery in Progress', isImportant = 1, recipientList = {'police'}, length = '15000', blipSprite = 108, blipColour = 1, blipScale = 1.3, infoM = 'fa-info-circle', info = 'Perampokan Bank Central'}
        local dispatchData = {dispatchData = data, caller = 'Alarm', coords = GetEntityCoords(cache.ped)}
        TriggerServerEvent('wf-alerts:svNotify', dispatchData)

        TriggerServerEvent("marskuy_ganteng:policeDoor", 1, false)
        self:HandleInfo()
    elseif self.currentplant == 1 then
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", newmodel, vector3(self.inside1.x, self.inside1.y, self.inside1.z), false)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 4, false)
    elseif self.currentplant == 2 then
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", newmodel, vector3(self.inside2.x, self.inside2.y, self.inside2.z), false)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 5, false)
    end
end
function UTK:Lockpick()
    ...
    exports.ox_inventory:Progress({
        duration = 6000,
        label = self.text.lockpick..": Stage 1",
        useWhileDead = false,
        canCancel = false,
        disable = {
             move = true,
    ...
    ESX.ShowNotification("Stage 1 "..self.text.stage)
    ...
    exports.ox_inventory:Progress({
        duration = 6000,
        label = self.text.lockpick..": Stage 2",
        useWhileDead = false,
        canCancel = false,
        disable = {
             move = true,
    ...
    ESX.ShowNotification("Stage 2 "..self.text.stage)
    ESX.ShowNotification(self.text.unlocked)
    UTK.disableinput = false
    if self.currentpick == 0 then
        UTK.stage0break = true
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", self.silentstart.type, vector3(self.silentstart.x, self.silentstart.y, self.silentstart.z), false, self.silentstart.h)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 2, false)
        self:HandleInfo()
    elseif self.currentpick == 1 then
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", self.inside1.type, vector3(self.inside1.x, self.inside1.y, self.inside1.z), false, self.inside1.h)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 4, false)
    elseif self.currentpick == 2 then
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", self.inside1.type, vector3(self.inside2.x, self.inside2.y, self.inside2.z), false, self.inside2.h)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 5, false)
    end
end
function UTK:Hack()
...
function UTK:IdCard()
    ...
    if self.currentid == 1 then
        UTK.disableinput = false
        ESX.ShowNotification(UTK.text.unlocked)
        --TriggerServerEvent("marskuy_ganteng:toggleDoor", UTK.hack1.type, vector3(UTK.hack1.x, UTK.hack1.y, UTK.hack1.z), false, UTK.hack1.h)
        TriggerServerEvent("marskuy_ganteng:policeDoor", 3, false)
    elseif self.currentid == 2 then
        UTK.stage1break = true
        UTK.disableinput = false
        exports.ox_inventory:Progress({
            duration = 4000,
            label = UTK.text.using,
            useWhileDead = false,
            canCancel = false,
            disable = {
                 move = true,
        ...
        repeat
            ...
            count = count - 1
        until count == 0
        ESX.ShowNotification(UTK.text.used)
        SpawnObj()
        TriggerServerEvent("marskuy_ganteng:openvault", 1)
        TriggerEvent("marskuy_ganteng:vaulttimer", 2)
        TriggerServerEvent("marskuy_ganteng:alarm_s", 1)
        self.info.stage = 2
        self.info.style = 2
        self:HandleInfo()
...
function SpawnObj()
    ...
    TriggerServerEvent("marskuy_ganteng:startloot")
end
			    ...
			    if HasAnimEventFired(ped, GetHashKey("RELEASE_CASH_DESTROY")) then
				    if IsEntityVisible(grabobj) then
                        ...
                        if currentgrab < 4 then
                            TriggerServerEvent("marskuy_ganteng:rewardCash")
                        elseif currentgrab == 4 then
                            TriggerServerEvent("marskuy_ganteng:rewardGold")
                        elseif currentgrab == 5 then
                            TriggerServerEvent("marskuy_ganteng:rewardDia")
                        end
				    end
			    end
		    end
        ...
        if HasScaleformMovieLoaded(scaleform) and UsingComputer then
            ...
            if IsScaleformMovieMethodReturnValueReady(ClickReturn) then
                ...
                if program == 82 and not Hacking then
                    ...
                    PopScaleformMovieFunctionVoid()
                    Hacking = true
                    ESX.ShowNotification("Find the IP adress...")
                elseif program == 83 and not Hacking and Ipfinished then
                    ...
                    Hacking = true
                    ESX.ShowNotification("Find the password...")
                ...
                elseif Hacking and program == 84 then
                    ...
                    Hacking = false
                    Ipfinished = true
                    ESX.ShowNotification("Run BruteForce.exe")
                ...
                elseif Hacking and program == 86 then
                    ...
                    elseif UTK.hackmethod == 2 then
                        ...
                        UsingComputer = false
                        Ipfinished = false
                        Process(19000, "System hacking...")
                        TriggerEvent("marskuy_ganteng:vaulttimer", 1)
                        TriggerServerEvent("marskuy_ganteng:openvault", 1)
                        ESX.ShowNotification(UTK.text.hacked)
                        UTK.disableinput = false
                        UTK.hackfinish = true
...
RegisterNetEvent("marskuy_ganteng:policeDoor_c")
AddEventHandler("marskuy_ganteng:policeDoor_c", function(doornum, status)
    PoliceDoors[doornum].locked = status
end)
RegisterNetEvent("marskuy_ganteng:openvault_c")
AddEventHandler("marskuy_ganteng:openvault_c", function(method)
    TriggerEvent("marskuy_ganteng:vault", method)
    TriggerEvent("marskuy_ganteng:vaultsound")
end)
RegisterNetEvent("marskuy_ganteng:vault")
AddEventHandler("marskuy_ganteng:vault", function(method)
...
RegisterNetEvent("marskuy_ganteng:vaultsound")
AddEventHandler("marskuy_ganteng:vaultsound", function()
    local coords = GetEntityCoords(PlayerPedId())
    local count = 0
...
RegisterNetEvent('marskuy_ganteng:alarm')
AddEventHandler('marskuy_ganteng:alarm', function(status)
    if status == 1 then
        PlaySound = true
...
RegisterNetEvent("marskuy_ganteng:updatecheck_c")
AddEventHandler("marskuy_ganteng:updatecheck_c", function(var, status)
    UTK.checks[var] = status
end)
RegisterNetEvent("marskuy_ganteng:startloot_c")
AddEventHandler("marskuy_ganteng:startloot_c", function()
    UTK.startloot = true
end)
RegisterNetEvent("marskuy_ganteng:vaulttimer")
AddEventHandler("marskuy_ganteng:vaulttimer", function(method)
    if method == 1 then
        ESX.ShowNotification("You have 180 seconds until toxic gas comes in.", 'error')
        UTK.starttimer = true
        UTK.vaulttime = 180
        CreateThread(function()
            while true do
        ...
        TriggerServerEvent("marskuy_ganteng:ostimer")
        TriggerServerEvent("marskuy_ganteng:gas")
        CreateThread(function()
        ...
        Wait(30000)
        UTK.begingas = false
        TriggerServerEvent("marskuy_ganteng:alarm_s", 2)
        ESX.TriggerServerCallback("marskuy_ganteng:gettotalcash", function(result)
            text = "$"..ESX.Math.GroupDigits(result)
            ESX.ShowNotification("You stole "..text)
        end)
    else
        ESX.ShowNotification("You have 180 seconds until toxic gas comes in.", "error")
        UTK.starttimer = true
...
RegisterNetEvent("marskuy_ganteng:gas_c")
AddEventHandler("marskuy_ganteng:gas_c", function()
    CreateThread(function()
        UTK.begingas = true
        --ESX.ShowNotification("Vault door will close automatically in 60 seconds!", "error")
        while true do
            Wait(1)
            if UTK.begingas then
    ...
    CreateThread(function()
        while true do
            ...
            if UTK.begingas then
                ...
                --ESX.ShowNotification("VAULT DOOR CLOSING!", 'error')
                TriggerEvent("marskuy_ganteng:vault", 2)
                TriggerEvent("marskuy_ganteng:vaultsound")
                for k, v in ipairs(UTK.doorchecks) do
                    if k == 1 or k == 4 or k == 5 then
                        TriggerEvent("marskuy_ganteng:moltgate_c", v.x, v.y, v.z, v.h1, v.h2, 2)
                    end
                end
                UTK.begingas = false
                if UTK.grabber then
...
RegisterNetEvent("marskuy_ganteng:policenotify")
AddEventHandler("marskuy_ganteng:policenotify", function(toggle)
    local player = ESX.GetPlayerData()
    if player.job.name == "police" then
        if toggle == 1 then
            ESX.ShowNotification("Pacific Standart Bank alarms are triggered!")
...
--[[RegisterNetEvent("marskuy_ganteng:toggleDoor_c")
AddEventHandler("marskuy_ganteng:toggleDoor_c", function(door, coord, status)
    local obj = ESX.Game.GetClosestObject(door, coord)

    FreezeEntityPosition(obj, status)
end)]]
RegisterNetEvent("marskuy_ganteng:moltgate_c")
AddEventHandler("marskuy_ganteng:moltgate_c", function(x, y, z, oldmodel, newmodel, method)
    if method == 2 then
...
RegisterNetEvent("marskuy_ganteng:fixdoor_c")
AddEventHandler("marskuy_ganteng:fixdoor_c", function(hash, coords, heading)
...
RegisterNetEvent("marskuy_ganteng:ptfx_c")
AddEventHandler("marskuy_ganteng:ptfx_c", function(method)
    local ptfx
...
RegisterNetEvent("marskuy_ganteng:reset")
AddEventHandler("marskuy_ganteng:reset", function()
    UTK.stage1break = true
    UTK.stage2break = true
    UTK.stage4break = true
    UTK.stagelootbreak = false
        ...
        while true do
            if UTK.startloot then
                ...
                if not UTK.checks.grab1 then
                    ...
                    if dst1 <= 4 then
                        DrawText3DBank(UTK.cash1.x, UTK.cash1.y, UTK.cash1.z, UTK.text.lootcash, 0.40)
                        if dst1 < 1 and IsControlJustReleased(0, 38) then
                            UTK.checks.grab1 = true
                            TriggerServerEvent("marskuy_ganteng:updatecheck", "grab1", true)
                            Loot(1)
                        end
                    end
                end
                if not UTK.checks.grab2 then
                    ...
                    if dst2 <= 4 then
                        DrawText3DBank(UTK.cash2.x, UTK.cash2.y, UTK.cash2.z, UTK.text.lootcash, 0.40)
                        if dst2 < 1 and IsControlJustReleased(0, 38) then
                            UTK.checks.grab2 = true
                            TriggerServerEvent("marskuy_ganteng:updatecheck", "grab2", true)
                            Loot(2)
                        end
                    end
                end
                if not UTK.checks.grab3 then
                    ...
                    if dst3 <= 4 then
                        DrawText3DBank(UTK.cash3.x, UTK.cash3.y, UTK.cash3.z, UTK.text.lootcash, 0.40)
                        if dst3 < 1 and IsControlJustReleased(0, 38) then
                            UTK.checks.grab3 = true
                            TriggerServerEvent("marskuy_ganteng:updatecheck", "grab3", true)
                            Loot(3)
                        end
                    end
                end
                if not UTK.checks.grab4 then
                    ...
                    if dst4 <= 4 then
                        DrawText3DBank(UTK.gold.x, UTK.gold.y, UTK.gold.z, UTK.text.lootgold, 0.40)
                        if dst4 < 1 and IsControlJustReleased(0, 38) then
                            UTK.checks.grab4 = true
                            TriggerServerEvent("marskuy_ganteng:updatecheck", "grab4", true)
                            Loot(4)
                        end
                    end
                end
                if not UTK.checks.grab5 then
                    ...
                    if dst5 <= 4 then
                        DrawText3DBank(UTK.dia.x, UTK.dia.y, UTK.dia.z, UTK.text.lootdia, 0.40)
                        if dst5 < 1 and IsControlJustReleased(0, 38) then
                            UTK.checks.grab5 = true
                            TriggerServerEvent("marskuy_ganteng:updatecheck", "grab5", true)
                            Loot(5)
                        end
                    end
                end
...
CreateThread(function()
    ...
    ESX.TriggerServerCallback("marskuy_ganteng:GetDoors", function(result)
        PoliceDoors = result
    end)
            ...
            if dst <= 10 then
                ...
                if PlayerData.job.name == "police" then
                    if dst <= 1.5 then
                        ...
                        DrawText3DBank(x, y, z, doortext, 0.40)
                        if IsControlJustReleased(0, 38)  then
                            TriggerServerEvent("marskuy_ganteng:policeDoor", k, state)
                        end
                    end
                end
            end
...
CreateThread(function() while true do Wait(1) if PlaySound then local lCoords = GetEntityCoords(PlayerPedId()) local eCoords = vector3(257.10, 220.30, 106.28) local distIs  = Vdist(lCoords.x, lCoords.y, lCoords.z, eCoords) if(distIs <= 50) then SendNUIMessage({transactionType = 'playSound'}) Wait(28000) else SendNUIMessage({transactionType = 'stopSound'}) end end end end)
CreateThread(function() while ESX == nil do TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end) Wait(1) end Wait(10000) UTK:GetInfo() end)