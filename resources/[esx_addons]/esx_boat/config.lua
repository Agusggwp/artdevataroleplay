...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 12000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 12000},
	{model = 'suntrap', label = 'Suntrap', price = 18000},
	{model = 'jetmax', label = 'Jetmax', price = 65000},
	{model = 'tropic2', label = 'Tropic', price = 85000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 45000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 55000},
	{model = 'speeder', label = 'Speeder', price = 110000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 90000},
	{model = 'toro', label = 'Toro', price = 275000},
	{model = 'submersible', label = 'Submersible', price = 900000}
}
