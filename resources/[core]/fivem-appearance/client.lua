        ...
        if CurrentAction ~= nil then
            ...
            if IsControlPressed(1, 38) then
                ...
                elseif CurrentAction == 'barberMenu' then
                    if Config.BarberShopPrice >= ox_inventory:Search(2, 'money') then
                        ESX.ShowNotification('Anda tidak memiliki uang yang cukup!')
                    else
                        local config = {
                            ped = false,
                            headBlend = false,
                        ...
                        exports['fivem-appearance']:startPlayerCustomization(function (appearance)
                            if (appearance) then
                                TriggerServerEvent('fivem-appearance:save', appearance, Config.BarberShopPrice)
                ...
                elseif CurrentAction == 'tattooMenu' then
                    if Config.TattooShopPrice >= ox_inventory:Search(2, 'money') then
                        ESX.ShowNotification('Anda tidak memiliki uang yang cukup!')
                    else
                        local config = {
                            ped = false,
                        ...
                        exports['fivem-appearance']:startPlayerCustomization(function (appearance)
                            if (appearance) then
                                TriggerServerEvent('fivem-appearance:save', appearance, Config.TattooShopPrice)
                                ESX.SetPlayerData('ped', PlayerPedId())
                                TriggerEvent('esx:restoreLoadout')
                            else
                                ESX.SetPlayerData('ped', PlayerPedId())
...
RegisterNetEvent('fivem-appearance:clothingMenu', function()
    if Config.ClothesShopPrice >= ox_inventory:Search(2, 'money') then
        ESX.ShowNotification('Anda tidak memiliki uang yang cukup!')
    else
        local config = {
            ped = false,
        ...
        exports['fivem-appearance']:startPlayerCustomization(function (appearance)
            if (appearance) then
                TriggerServerEvent('fivem-appearance:save', appearance, Config.ClothesShopPrice)
