...
CreateThread(function()
	...
	local query = '`accounts`, `job`, `job_grade`, `group`, `position`, `inventory`, `skin`, `phone_number`, `metadata`'
...
function loadESXPlayer(identifier, playerId, isNew)
	...
	MySQL.prepare(LoadPlayer, { identifier }, function(result)
		...
		if result.phone_number then
			...
			userData.phone_number = ESX.CreatePhoneNumber(identifier)
		end
		
		userData.phonedata = {}
		if result.metadata then
			userData.phonedata = json.decode(result.metadata)
		end
		userData.phonedata.phone_number = userData.phone_number
		...
		local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.job, userData.playerName, userData.coords, userData.phone_number)
		ESX.Players[playerId] = xPlayer

		if userData.firstname then
			xPlayer.set('firstName', userData.firstname)
			xPlayer.set('lastName', userData.lastname)
			xPlayer.set("phonedata", userData.phonedata)
