...
VehicleShop = {
    ['pdm'] = { -- same with name
        ...
        displaycars = {
            ...
            [2] = {model = 'fmj', value = 1000000, coord = vector4(-51.99, -1091.67, 26.42, 196.82)},
            [3] = {model = 'zentorno', value = 1000000, coord = vector4(-43.318450927734,-1102.1627197266,25.758722305298,340.29724121094)},
        }
    },
    ...
    name = "Ambulance Vehicle Shop", --amubulance police shop
    title = "Ambulance Vehicle Shop",
    icon = 'https://i.imgur.com/t1OPuVL.png',
    job = 'ambulance',
    type = 'car',
    default_garage = 'eclipse',
    Dist = 3, -- distance (DEPRECATED)
    ShowBlip = false,
    Blip = {color = 38, sprite = 662, scale = 0.7},
    shop_x = -664.3451,
    shop_y = 334.8818,
    shop_z = 78.1183, -- coordinates for this garage
    spawn_x = -662.6864,
    spawn_y = 338.0565,
    spawn_z = 76.8867,
    heading = 84.7651, -- Vehicle spawn location
    plateprefix = 'AMBL', -- carefull using this, maximum should be 4, recommended is 3, use this only for limited vehicles, if you use this parameter in other shop, you might have a limited plates available, ex. LSPD1234 (max char of plate is 8) it means you only have 9999 vehicles possible with this LSPD
    shop = { -- if not vehicle is setup in Database SQL, we will use this
    {shop='Ambulance Vehicle Shop',category='Ambulance SUVs',stock=50,price=100000,model='ambulance',name="Ambulance",grade = 0},
    },
},
