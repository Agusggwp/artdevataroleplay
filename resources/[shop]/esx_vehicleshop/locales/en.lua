Locales['en'] = {
  ...
  ['customer_date']           = 'date',
      ...
      ['no'] = 'no',
      ['not_enough_money'] = 'you do not have enough money',
      ['press_menu'] = 'Press ~INPUT_CONTEXT~ to interact',
      ...
      ['shop_clothes'] = 'toko baju',
      ['player_clothes'] = 'saved clothes',
      ['suppr_cloth'] = 'delete outfit',
      ['shop_main_menu'] = 'Toko Baju',
      -- Barbershop
      ['valid_purchase'] = 'validate this purchase?',
      ['press_access'] = 'press ~INPUT_CONTEXT~ to interact',
      ['barber_blip'] = 'Barber Shop',
      -- Boat rental
      ['boat_rental'] = 'Boat Rent',
      ['press_rent'] = 'press ~INPUT_CONTEXT~ to interact',
      -- Tattoo
      ['tattoo_shop_prompt'] = 'Tekan ~INPUT_PICKUP~ untuk membuat ~y~Tattoo~s~.',
    ['money_amount']       = '<span style="color:green;">Rp.%s</span>',
    ['part']               = 'Bagian %s',
    ['go_back_to_menu']    = '< Kembali',
    ['tattoo_item']        = 'Tattoo %s - %s',
    ['tattoos']            = 'Tattoo',
    ['tattoo_shop']        = 'Seni Tattoo',
    ['bought_tattoo']      = 'Kamu membuat ~y~Tattoo~s~ seharga ~r~Rp.%s~s~',
}
