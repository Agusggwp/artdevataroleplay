...
RegisterCommand('kuncikendaraan', function()
	ToggleVehicleLock()
end, false)
RegisterKeyMapping('kuncikendaraan', 'Toggle Vehicle Locks', 'keyboard', 'u')