...
RegisterNetEvent('marskuy-dealer:openmenu')
AddEventHandler('marskuy-dealer:openmenu', function ()
	OpenShopMenu()
end)

-- TODO : PDM JOBS ACTION
Citizen.CreateThread(function()
	local dealer = {
		-1589423867
	}
	exports.qtarget:AddTargetModel(dealer, {
		options = {
			{
				event = "marskuy-dealer:openmenu",
				icon = "fas fa-car",
				label = "Open PDM Vehicle Shop",
			},
			{
				event = "cancel",
