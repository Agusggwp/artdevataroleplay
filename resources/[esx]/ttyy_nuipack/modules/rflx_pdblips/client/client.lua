...
Citizen.CreateThread(function()
    ...
    if JobBlip.useRflxMulti then
        while exports['ttyy_nuipack']:getChar() == nil do
            Wait(100)
        end
    else
    ...
    if JobBlip.useRflxMulti then
	    PlayerData.char = exports['ttyy_nuipack']:getChar()
    end
...
function goOnDuty()
    ...
    if JobBlip.notifications.enable and JobBlip.notifications.useMythic then
        exports['ttyy_nuipack']:Alert('inform', JobBlip.notifications.onDutyText)
...
function goOffDuty()
    ...
    if JobBlip.notifications.enable and JobBlip.notifications.useMythic then
        exports['ttyy_nuipack']:Alert('inform', JobBlip.notifications.offDutyText)
    elseif JobBlip.notifications.enable then
