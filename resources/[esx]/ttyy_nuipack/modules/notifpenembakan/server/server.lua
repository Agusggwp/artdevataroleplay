...
local dispatchCodes = {
	...
	melee = { displayCode = '10-10', description = ('Fight in progress'), isImportant = 0, recipientList = {'police'},
	blipSprite = 652, blipColour = 84, blipScale = 1.5 },

	officerdown = {displayCode = '10-99', description = ('Officer is down'), isImportant = 1, recipientList = {'police', 'fib'},
	blipSprite = 653, blipColour = 84, blipScale = 1.5, infoM = 'fa-portrait'},

	persondown = {displayCode = '10-52', description = ('Person is injured'), isImportant = 0, recipientList = {'police', 'fib'},
	blipSprite = 153, blipColour = 84, blipScale = 1.5, infoM = 'fa-portrait'},

	autotheft = {displayCode = '10-16', description = ('Theft of a motor vehicle'), isImportant = 0, recipientList = {'police'},
	blipSprite = 651, blipColour = 84, blipScale = 1.5, infoM = 'fa-car', infoM2 = 'fa-palette' },

	speeding = {displayCode = '10-66', description = ('Reckless driving'), isImportant = 0, recipientList = {'police'},
	blipSprite = 650, blipColour = 84, blipScale = 1.5, infoM = 'fa-car', infoM2 = 'fa-palette' },

	shooting = { displayCode = '10-13', description = ('Discharge of a firearm'), isImportant = 0, recipientList = {'police', 'fib'},
	blipSprite = 648, blipColour = 84, blipScale = 1.5 },

	driveby = { displayCode = '10-13', description = ('Drive-by shooting'), isImportant = 0, recipientList = {'police'},
...
AddEventHandler('wf-alerts:svNotify911', function(message, caller, coords, data)
	if message ~= nil then
		...
		if caller == ('Caller Unknown') then pData.dispatchMessage = ('Unknown caller') end
		pData.recipientList = {'police', 'fib'}
		pData.length = 13000
