...
local Drawables = {
	...
	["Shoes"] = {
		Drawable = 6,
		Table = { Standalone = true, Male = 96, Female = 59 },
...
local Extras = {
	["Shirt"] = {
		Drawable = 11,
		Table = {
			Standalone = true, Male = 15, Female = 146,
			Extra = { 
...
RegisterNetEvent('dwkCloth:toggleClothing')
AddEventHandler('dwkCloth:toggleClothing', function(which, extra)
	ExecuteCommand(Lang(which))
	-- ToggleClothing(which, extra)
end)
