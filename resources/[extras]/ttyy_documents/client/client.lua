...
RegisterNUICallback('getPlayerData', function(data, cb)
  if CurrentFramework == "esx" then
    ESX.TriggerServerCallback('ttyy_documents:getPlayerData', function(result)
      cb(result)
    end)
  elseif CurrentFramework == "qb" then
...
RegisterNUICallback('getPlayerCopies', function(data, cb)
  TriggerCallback('ttyy_documents:getPlayerCopies', function(result)
    cb(result)
  end)
end)

RegisterNUICallback('getIssuedDocuments', function(data, cb)
  TriggerCallback('ttyy_documents:getPlayerDocuments', function(result)
    cb(result)
  end)
end)

RegisterNUICallback('createDocument', function(data, cb)
  TriggerCallback('ttyy_documents:createDocument',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('createTemplate', function(data, cb)
  TriggerCallback('ttyy_documents:createTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('editTemplate', function(data, cb)
  TriggerCallback('ttyy_documents:editTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('deleteTemplate', function(data, cb)
  TriggerCallback('ttyy_documents:deleteTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('deleteDocument', function(data, cb)
  TriggerCallback('ttyy_documents:deleteDocument',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('getMyTemplates', function(data, cb)
  TriggerCallback('ttyy_documents:getDocumentTemplates', function(result)
    cb(result)
  end)
end)
...
RegisterNUICallback('giveCopy', function(data, cb)
  Citizen.CreateThread(function()
    ...
    if targetId == -1 then
      ...
      TriggerServerEvent("ttyy_documents:giveCopy", data, targetId)
    end
  end)
end)
...
RegisterNUICallback('showDocument', function(data, cb)
  Citizen.CreateThread(function()
    ...
    if targetId == -1 then
      ...
      TriggerServerEvent("ttyy_documents:receiveDocument", data, targetId)
    end
  end)
end)

RegisterNetEvent('ttyy_documents:copyGave')
AddEventHandler('ttyy_documents:copyGave', function(data)
	holdDocument(false)
  playAnim("mp_common", "givetake1_a", 1500)
  Notification(Config.Locale.giveNotification .. " " .. data)
end)

RegisterNetEvent("ttyy_documents:useItem")
AddEventHandler("ttyy_documents:useItem", function()
	toggleNuiFrame(true, true)
end)


RegisterNetEvent('ttyy_documents:copyReceived')
AddEventHandler('ttyy_documents:copyReceived', function(data)
  Notification(Config.Locale.receiveNotification .. " " .. data)
end)

RegisterNetEvent('ttyy_documents:viewDocument')
AddEventHandler('ttyy_documents:viewDocument', function(data)
