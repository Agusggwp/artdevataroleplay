...
Config["ClientTrigger1"] = "ttyy_chairs:Chair1"
Config["ClientTrigger2"] = "ttyy_chairs:Chair2"
...
--[[
    ...
    ____________________________________
    TriggerEvent('ttyy_chairs:Chair1')
    TriggerEvent('ttyy_chairs:Chair2')
    ____________________________________
    These are clientside triggers incase you'd like a server event to trigger them simply just do 
    ____________________________________
    SERVER SIDE EVENT TRIGGERS
    ____________________________________
    TriggerClientEvent('ttyy_chairs:Chair1', source)
    TriggerClientEvent('ttyy_chairs:Chair2', source)
