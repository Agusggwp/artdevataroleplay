...
AddEventHandler('ttyy_elevators:goToFloor', function(data)
...
AddEventHandler('ttyy_elevators:noAccess', function()
    lib.notify({
        title = 'No Access',
...
AddEventHandler('ttyy_elevators:openMenu', function(data)
        ...
        elseif v.groups then
            ...
            if found then
                table.insert(Options, {
                    title = v.title,
                    description = v.description,
                    event = 'ttyy_elevators:goToFloor',
                    args = { elevator = elevator, floor = k }
                })
            else
                table.insert(Options, {
