...
RegisterServerEvent('ttyy_backpack:openBackpack')
AddEventHandler('ttyy_backpack:openBackpack', function(identifier)
...
lib.callback.register('ttyy_backpack:getNewIdentifier', function(source, slot)
