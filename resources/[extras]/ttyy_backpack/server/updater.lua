...
if Config.checkForUpdates then
    ...
    local resourceName = "ttyy_backpack"

    CreateThread(function()
        if GetCurrentResourceName() ~= "ttyy_backpack" then
            resourceName = "ttyy_backpack (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/ttyy_backpack/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/ttyy_backpack/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/ttyy_backpack"
            end
        end, "GET")
