...
RegisterCommand(Config.OpenScore,function ()
    ...
    if Config.Framework == "QBCORE" then
            QBCore.Functions.TriggerCallback('ttyy_scoreboard:CurrentPlayers', function(oPlayers)
                ped = PlayerPedId()
            ...
            QBCore.Functions.TriggerCallback('ttyy_scoreboard:CurrentJobs', function(police, ambulance, mechanic, realestate, taxi, abogado)
                ped = PlayerPedId()
                pid = GetPlayerServerId(PlayerId())
                PlayerData = QBCore.Functions.GetPlayerData()    
                playerId = PlayerId()
    ...
    elseif Config.Framework == "ESX" then
        ESX.PlayerData = ESX.GetPlayerData()
                ...
                ESX.TriggerServerCallback('ttyy_scoreboard:CurrentJobs', function(police, ambulance, mechanic, realestate, taxi, abogado, oPlayers, rpName ,rPhone)
                    SendNUIMessage({
                        action = 'updatedatajob',
                        mechanic = mechanic,
                        police = police,
