...
TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)
    ESX.RegisterServerCallback('ttyy_scoreboard:CurrentJobs', function(source, cb)
...
elseif Config.Framework == "QBCORE" then
    ...
    QBCore.Functions.CreateCallback('ttyy_scoreboard:CurrentPlayers', function(source, cb)
       local TotalPlayers = 0
    ...
    QBCore.Functions.CreateCallback('ttyy_scoreboard:CurrentJobs', function(source, cb)
        local MechanicCount = 0
