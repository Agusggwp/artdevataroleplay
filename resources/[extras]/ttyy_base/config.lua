...
Config.vehicleModel = "x6mf96"

Config.Zones = {
    CarSpawn = {
        Pos     = vector3(-1101.32, -260.94, 37.7),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 202.86,
		Type    = -1
    },
    MarkerCoords = vector3(-114.51, -599.72, 36.28)

}

Config_Tackle 				  = {}
Config_Tackle.Timer = 10000 -- Time between tackling

Config_Tackle.TTT = 8000 -- TTT = Tackle Target Timer

Config_Tackle.en = {
    commandlabel = 'Tackle For Police'
}

Config_Tackle.hu = {
    commandlabel = 'Vetödés (Rendör)'
}

-- Report Bug
Config_Bug        = {}
Config_Bug.Locale = 'en'

Config_Bug.discordwebhooklink = ''
Config_Bug.displayidentifiers = false -- Display the user identifiers in the embed? Steam id, discord id etc
