...
cfg = {
	...
	damageFactorPetrolTank = 50.0,				-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 64
	...
	degradingFailureThreshold = 377.0,			-- Below this value, slow health degradation will set in
...
repairCfg = {
	mechanics = {
		...
		{name="Mechanic", id=446, r=30.0, x=208.0,  y=4103.0,  z=38.0},		-- Mechanic East Joshua Rd.
		...
		{name="Mechanic", id=446, r=33.0, x=-1419.0, y=-40.0,  z=36.0},		-- Hayes Auto Body Shop, Del Perro
