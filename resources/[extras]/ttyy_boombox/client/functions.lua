            ...
            while true do
                if DoesEntityExist(obj) and not targetPlaced then
                    exports.qtarget:AddBoxZone("boomboxzone", coords, 1, 1, {
                        ...
                        options = {
                            {
                                event = 'ttyy_boombox:interact',
                                icon = 'fas fa-hand-paper',
                                label = 'Interact',
                            },
                            {
                                event = 'ttyy_boombox:pickup',
        ...
        options = {
            {
                ...
                arrow = false,
                event = 'ttyy_boombox:playSavedSong',
                args = data
            },
            {
                title = 'Delete Song',
...
if Config.Framework == "ESX" then
    savedSongsMenu = function(radio)
        ESX.TriggerServerCallback('ttyy_boombox:getSavedSongs', function(cb)
            ...
            if cb then
                for i=1, #cb do
                    ...
                    table.insert(Options, {
                        ...
                        description = '',
                        arrow = true,
                        event = 'ttyy_boombox:selectSavedSong',
...
elseif Config.Framework == "QB" then
    savedSongsMenu = function(radio)
        QBCore.Functions.TriggerCallback('ttyy_boombox:getSavedSongs', function(cb)
            local radio = radio.id
            local Options = {
                {
                    title = 'Save A Song',
