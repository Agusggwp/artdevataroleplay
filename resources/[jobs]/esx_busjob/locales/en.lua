Locales['en'] = {
    ...
    ['money_earned_label']                  = 'Pendapatan',
    ['stops_remaining_label']               = 'Pemberhentian',

    ['abort_route']                         = 'Cancel ~g~%s',
    ['airport_route']                       = 'Pool Bus Kampung',
    ['bandara_route']                       = 'Pool Bus Bandara',
    ['scenic_route']                        = 'Pool Bus Antar Kota',
    ['disnaker_route']                      = 'Pool Bus Karyawan',
    ['metro_route']                         = 'Pool Bus Kota',
    ...
    ['terminal']                            = 'Terminal',
    ['get_back_in_bus']                     = 'Silahkan menggunakan bus untuk melanjutkan.',
