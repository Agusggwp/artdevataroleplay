...
Cfg_Mecha.DrawDistance               = 20.0 -- How close you need to be in order for the markers to be drawn (in GTA units).
Cfg_Mecha.MaxInService               = -1
Cfg_Mecha.EnablePlayerManagement     = true -- Enable society managing.
Cfg_Mecha.EnableSocietyOwnedVehicles = false

Cfg_Mecha.NPCSpawnDistance           = 500.0
Cfg_Mecha.NPCNextToDistance          = 25.0
Cfg_Mecha.NPCJobEarnings             = { min = 15, max = 40 }
...
Cfg_Mecha.Zones = {
	...
	MechanicActions = {
		Pos   = {x = 875.5839,y = -2124.5732,z = 30.5586},
...
for k,v in ipairs(Cfg_Mecha.Towables) do
	Cfg_Mecha.Zones['Towable' .. k] = {
		Pos   = v,
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1
