RegisterCommand('deployramp', function ()
    ...
    if IsAnyVehicleNearPoint(playerCoords, radius) then
        ...
        if contains(vehicleName, Cfg_Flat.Flatbed) then
            local vehicleCoords = GetEntityCoords(vehicle)

            for _, value in pairs(Cfg_Flat.offsets) do
...
RegisterNetEvent('ttyy_mechanic:DeployRamp', function()
...
RegisterNetEvent('ttyy_mechanic:RemoveRamp', function()
...
RegisterCommand('attach', function()
    ...
    if IsPedInAnyVehicle(player, false) then
        ...
        if GetPedInVehicleSeat(vehicle, -1) == player then
            ...
            if contains(vehicleBelowName, Cfg_Flat.Flatbed) then
...
RegisterNetEvent('ttyy_mechanic:AttachRamp', function()
...
RegisterNetEvent('ttyy_mechanic:DetachRamp', function()
