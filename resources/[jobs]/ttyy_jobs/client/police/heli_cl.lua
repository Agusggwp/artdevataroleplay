...
-- Script starts here
local helicam = true
local eurocopter_hash = GetHashKey("eurocopter")
...
function helicam()
	...
	if IsHeliHighEnough(heli) and IsPlayerInEurocopter() then
...
-- TODO : NEW KEYMAPPING 
Citizen.CreateThread(function()
    RegisterKeyMapping("+helicam", "Heli Camera", "keyboard", "E")
    RegisterKeyMapping("+helirappel", "Heli Rappel", "keyboard", "X")
...
function IsPlayerIneurocopter()
	local lPed = PlayerPedId()
	local vehicle = GetVehiclePedIsIn(lPed)
	local isEurocopter = IsVehicleModel(vehicle, eurocopter_hash)
	local isEurocopter1 = IsVehicleModel(vehicle, eurocopter_hash2)
	local helihash3 = IsVehicleModel(vehicle, heli_hash3)
	if isEurocopter or isEurocopter1 or helihash3 then
		return true
	else
		return false
	end
