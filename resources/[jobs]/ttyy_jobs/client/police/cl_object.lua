...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if objectId == nil then return exports.ttyy_nuipack:Alert('Police Object','No Object Spawned', 3000, 'error') end
...
RegisterNetEvent('police:client:spawnObject', function(objectId, type, player)
    ...
    local spawnedObj = CreateObject(Cfg_Object.Objects[type].model, x, y, z, true, false, false)
    PlaceObjectOnGroundProperly(spawnedObj)
    SetEntityHeading(spawnedObj, heading)
    FreezeEntityPosition(spawnedObj, Cfg_Object.Objects[type].freeze)
    ObjectList[objectId] = {
        id = objectId,
        object = spawnedObj,
