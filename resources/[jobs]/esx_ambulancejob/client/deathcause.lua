...
RegisterNetEvent('esx_checkdeathcause:emsCheck')
AddEventHandler('esx_checkdeathcause:emsCheck', function(data) 
	...
	options = {
		{
			...
			label = "EMS | Periksa",
			job = "all",
			canInteract = function(entity) return IsPedDeadOrDying(entity, 1) end
		},
	},
	distance = 2.5
})