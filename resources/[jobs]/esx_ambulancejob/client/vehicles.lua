...
function OpenVehicleSpawnerMenuAmbulance(type, hospital, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			...
			local shopCoords = vector3(228.5, -993.5, -99.5)
							...
							if data2.current.stored then
								...
								if foundSpawn then
									...
									ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
										...
										local platejob = 'EMS' .. math.random(100, 900) -- BARU
...
function OpenShopMenu(elements, restoreCoords, shopCoords)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		DeleteSpawnedVehiclesEMS()
		WaitForVehicleToLoadEMS(data.current.model)
...
RegisterNetEvent('ttyy-ambulance:openvehmenu')
AddEventHandler('ttyy-ambulance:openvehmenu', function ()
	OpenVehicleSpawnerMenuAmbulance('car', 'CentralLosSantos', 'Vehicles', 1)
end)

RegisterNetEvent('ttyyander:opengeki')
AddEventHandler('ttyy-ambulance:opengeki', function ()
	OpenVehicleSpawnerMenuAmbulance('helicopter', 'CentralLosSantos', 'Helicopters', 1)
end)

exports.qtarget:AddBoxZone('ambulanceveh', vector3(298.81, -571.98, 43.26), 2, 2, {
    name="ambulanceveh",
    heading=270,
    --debugPoly=true,
    minZ=41.26,
    maxZ=45.26
        ...
        options = {
            {
                event = "ttyy-ambulance:openvehmenu",
