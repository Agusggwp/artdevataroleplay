...
RegisterNetEvent('emsboss', function ()
	TriggerEvent('esx_society:boss', 'ambulance', function(data, menu)
		menu.close()
...
function OnPlayerDeath()
	...
	loadanimdict("dead")
	ClearPedTasksImmediately(PlayerPedId())
	TaskPlayAnim(PlayerPedId(), "dead", "dead_b", 1.0, 1.0, -1, 1, 0, 0, 0, 0)
...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
	...
	if itemName == 'medikit' then
		if ESX.PlayerData.job.name == 'ambulance' then
			TriggerEvent("eprobbery:client:progress", {
				name = "medikit",
				duration = 10000,
			...
			Notif:Alert('error', 'Kamu bukan EMS!', 4000)
		end
...
function SendDistressSignal()
	if Config.ttyyphone then
		local playerPed = PlayerPedId()
		local coords = GetEntityCoords(playerPed)
		local GPS = 'GPS: ' .. coords.x .. ', ' .. coords.y
  
	  ESX.ShowNotification(_U('distress_sent'))
	  TriggerEvent('ttyy_phone:ambulancedistress')
	  ...
	  TriggerServerEvent('gksphone:jbmessage', 'Distress', 0, 'Sinyal Baru', '', GPS, 'ambulance')
