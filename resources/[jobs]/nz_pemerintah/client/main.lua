        ...
        function(data, menu)
            ...
            if amount == nil or amount < 0 then
                ...
                if closestPlayer == -1 or closestDistance > 3.0 then
                    -- exports['ttyy_nuipack']:DoCustomHudText('inform', _U('no_players_nearby'), 2500, { ['background-color'] = '#FF0000', ['color'] = '#ffffff' })
...
RegisterNetEvent('ttyy:billPDG')
AddEventHandler('ttyy:billPDG', function()
    BukaBillingMenuPdg()
end)
