...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/iwmxwei.jpg",
-- You can change the menu position here
	MenuPosition = "right", -- (left, right)
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 21, -- Get the button number here https://docs.fivem.net/game-references/controls/
      RagdollKeybind2 = 58,
...
-- You can disable the Shared Emotes here.
      ...
      CustomFontFile = "greek",
      CustomFontId = "OpenSans",
      Locale = "en",
      Documents = {}
}
