...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://ttyy_gather/close', JSON.stringify({}));
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://ttyy_gather/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'DIPILIH') {
            $(document).find(".addjob").text('PILIH');
            $(this).text('DIPILIH');
            $.post('https://ttyy_gather/addjob', JSON.stringify({
