				...
				if DoesEntityExist(closestAnimal) and NetworkHasControlOfNetworkId(netid) then
					...
					exports.ox_inventory:Progress({
						...
						if not cancel then
							...
							isButchering = false
							TriggerServerEvent('ttyy_butcher:Catch', 'alive_chicken', 3)
							Wait(150)
...
function SpawnChickens()
	while spawnedChickenAlive < 15 do
		...
		ESX.Streaming.RequestModel(`a_c_hen`, function()
			local Animal = CreatePed(5, `a_c_hen`, chickenCoords, 0.0, true, false)
...
-- Animal handler
exports['qtarget']:AddTargetModel(chicken, {
	options = {
		{
...
exports['qtarget']:AddBoxZone("ttyy_butcher:Process", vector3(-95.0819, 6207.5879, 31.0259), 1.75, 1.70, {
	name="ttyy_butcher:Process",
	heading=315.4254,
	--debugPoly=false,
	minZ=27.67834,
	maxZ=33.67834,
...
exports['qtarget']:AddBoxZone("ttyy_butcher:Process2", vector3(-99.9406, 6201.8672, 31.0685), 1.0, 1.70, {
	name="ttyy_butcher:Process2",
	heading=227.2153,
	--debugPoly=false,
	minZ=29.67834,
	maxZ=31.67834,
