function LoadPlayerMoneys(){
    $.each(QB.Phone.Data.PlayerData.accounts, function(id, accdata){
        if (accdata.name == 'bank') {
            $(".details-bankmoney").html("$"+accdata.money)
        } else if (accdata.name == 'money') {
            $(".details-cashmoney").html("$"+accdata.money)
        }
    });

    var PlayerPhoneNumber = QB.Phone.Data.PlayerData.phonedata.phone_number;
    var PlayerBankAcc = "LOGI0264";
    var PlayerStateID = "LOGI0264";
