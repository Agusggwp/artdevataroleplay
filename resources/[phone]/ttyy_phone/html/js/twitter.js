...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('https://ttyy_phone/ClearMentions');
        }
...
$(document).on('click', '#twt-sendmessage-chat', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://ttyy_phone/PostNewTweet', JSON.stringify({
...
$(document).on('click','#twt-delete-click',function(e){
    ...
    $.post('https://ttyy_phone/DeleteTweet', JSON.stringify({id: source}))
})
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('https://ttyy_phone/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
