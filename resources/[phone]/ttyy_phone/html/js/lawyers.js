SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There are no officer available.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Lawyers (' + police.length + ')</h1>');

        if (lawyers.length > 0) {
            $.each(lawyers, function(i, lawyer1) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Lawyers (' + lawyers.length + ')</h1>');
